  ...
  return (
    <ScrollReveal>
      <div className="w-full flex justify-end items-center pb-1">
        <fieldset className="border border-(--bordes) rounded-xl p-1 w-full sm:w-1/2">
          <legend className="text-sm font-semibold text-(--texto) mx-2 px-2 mb-1">Filtrar por: </legend>
